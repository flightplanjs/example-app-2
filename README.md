...
[![lerna version](https://img.shields.io/github/package-json/dependency-version/flightplanjs/example-app-2/dev/lerna)](https://lerna.js.org/)
[![pnpm version](https://img.shields.io/github/package-json/packageManager/flightplanjs/example-app-2)](https://pnpm.io/)
[![Generate Release Candidate](https://github.com/flightplanjs/example-app-2/actions/workflows/release.yml/badge.svg?event=workflow_dispatch)](https://github.com/flightplanjs/example-app-2/actions/workflows/release.yml)
...
```sh
git clone git@github.com:flightplanjs/example-app-2.git
```
